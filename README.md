...
Git, python, python-pip, wget, unzip, automake, make, libtool, pkg-config, libhidapi-dev, gdb-arm-none-eabi, libudev-dev, python-serial, python3-serial
